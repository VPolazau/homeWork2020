...
38. --
39. Обработка ошибок над "36", конструкция try..catch, создал общую функцию http() для post и get запросов. Object.entries (обьект->массив) для разбиения хедерсов
